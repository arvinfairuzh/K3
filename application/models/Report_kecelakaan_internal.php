...
class Report_kecelakaan_internal extends CI_Model {
    ...
    var $column_order = array(null,'ip_nama','ip_nomor_induk','ip_dep_birobid','ip_bagian_seksi','nama_se','nama_kabag','nama_k3','nama_penderita','status_kecelakaan','nama_status'); //field yang ada di table user
    var $column_search = array(null,'ip_nama','ip_nomor_induk','ip_dep_birobid','ip_bagian_seksi','nama_se','nama_kabag','nama_k3','nama_penderita','status_kecelakaan','nama_status'); //field yang ada di table user
    var $order = array('ip_nama'=>'asc'); // default order 
    var $table = "(SELECT kecelakaan_main.id, kecelakaan_main.ip_nama, kecelakaan_main.ip_nomor_induk, kecelakaan_main.ip_dep_birobid, kecelakaan_main.ip_bagian_seksi, se.nama as nama_se, kabag.nama as nama_kabag, k3.nama as nama_k3, penderita.nama as nama_penderita, kecelakaan_main.status_kecelakaan, master_status_kecelakaan.nama as nama_status
...
WHERE kecelakaan_detail_internal.status = 'ENABLE') as tabledata";
