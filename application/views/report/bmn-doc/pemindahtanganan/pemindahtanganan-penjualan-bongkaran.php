...
<head>
  <title>
    Persetujuan Penjualan Bongkaran BMN
  </title>
...
<table style="width:100%;">
  ...
  <tr>
    <td>4.</td>
    <td>Penjualan Secara lelang atas BMN agar dilakukan melalui Kantor Pelayanan Kekayaan Negara dan Lelang (KPKNL) setempat dengan harga limit sebesar Rp. <?=@$surat['nilai'];?> (<?=@$surat['terbilang'];?>) berdasarkan penilaian panitia penghapusan Nomor <?=@$surat['nomor_berita'];?> tanggal <?=@$surat['tanggal_berita'];?>.</td>
  </tr>
  <tr>
    <td>5.</td>
