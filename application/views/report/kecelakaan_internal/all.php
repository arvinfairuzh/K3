  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Report Kecelakaan_internal</h1>
        ...
        <div class="col-md-12">
          <div class="panel panel-success">
            <div class="panel-heading">
              ...
              <div class="row">
                <div class="col-md-12">
                <a class="btn btn-success pull-right btn-flat" href="<?= base_url('report/Kecelakaan_internal/getExcel/') ?>" target="_blank"><i class="fa fa-file-excel-o"></i> Export Excel</a>
                </div>
              </div>
              <!-- FILTER  -->
            </div>
