  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <form method="POST" action="<?= base_url('master/Master_bagian/update') ?>" id="upload-create" enctype="multipart/form-data">

    <input type="hidden" name="id" value="<?= $master_bagian['id'] ?>">
