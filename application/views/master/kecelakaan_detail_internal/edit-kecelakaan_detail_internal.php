                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="form-kk_gambar_lokasi"  name="dt[kk_gambar_lokasi]" value="<?= $kecelakaan_detail_internal['kk_gambar_lokasi'] ?>">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <br><input type="radio" onclick="javascript:yesnoCheck();" id="yesCheck" name="dt[tw_apkh_1]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck();" id="noCheck" name="dt[tw_apkh_1]" <?PHP print $tidak; ?>>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck();" id="yesCheck1" name="dt[tw_apkh_2]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck();" id="noCheck1" name="dt[tw_apkh_2]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck();" id="yesCheck2" name="dt[tw_apkh_3]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck();" id="noCheck2" name="dt[tw_apkh_3]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck1();" id="yesCheck3" name="dt[sp_apkh_1]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck1();" id="noCheck3" name="dt[sp_apkh_1]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck2();" id="yesCheck4" name="dt[sp_apkh_2]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck2();" id="noCheck4" name="dt[sp_apkh_2]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck3();" id="yesCheck5" name="dt[pk__apkh_1]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck3();" id="noCheck5" name="dt[pk__apkh_1]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck4();" id="yesCheck6" name="dt[pk_apkh_2]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck4();" id="noCheck6" name="dt[pk_apkh_2]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck5();" id="yesCheck7" name="dt[pk_apkh_3]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck5();" id="noCheck7" name="dt[pk_apkh_3]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck6();" id="yesCheck8" name="dt[pk_apkh_3]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck6();" id="noCheck8" name="dt[pk_apkh_3]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck7();" id="yesCheck9" name="dt[papd_apkh_2]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck7();" id="noCheck9" name="dt[papd_apkh_2]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="form-md_gambar_1" placeholder="Masukan Md Gambar 1" name="dt[md_gambar_1]" value="<?= $kecelakaan_detail_internal['md_gambar_1'] ?>">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck8();" id="yesCheck10" name="dt[md_apkh_1]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck8();" id="noCheck10" name="dt[md_apkh_1]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" name="dt[md_apkh_2]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" name="dt[md_apkh_2]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck9();" id="yesCheck11" name="dt[md_apkh_3]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck9();" id="noCheck11" name="dt[md_apkh_3]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck10();" id="yesCheck12" name="dt[md_apkh_4]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck10();" id="noCheck12" name="dt[md_apkh_4]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck11();" id="yesCheck13" name="dt[md_apkh_5]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck11();" id="noCheck13" name="dt[md_apkh_5]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck12();" id="yesCheck14" name="dt[snp_apkh_1]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck12();" id="noCheck14" name="dt[snp_apkh_1]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <br><input type="radio" onclick="javascript:yesnoCheck13();" id="yesCheck15" name="dt[snp_apkh_2]" <?PHP print $ya; ?>>
                                <label for="Ya">Ya</label><br>
                                <input type="radio" onclick="javascript:yesnoCheck13();" id="noCheck15" name="dt[snp_apkh_2]" <?PHP print $tidak; ?>>
                                <label for="Tidak">Tidak</label>
                            </div>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="pttk_kondisi_lingkungan_lainnya" value="<?= $kecelakaan_detail_internal['pttk_kondisi_lingkungan'] ?>">
                                        </td>
                                    </tr>
                                </table>
                            </div>
