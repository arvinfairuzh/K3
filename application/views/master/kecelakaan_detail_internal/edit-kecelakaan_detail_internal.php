                        ...
                        <div class="box-body">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="form-kk_tanggal_jam" name="dt[kk_tanggal_jam]" value="<?= $kecelakaan_detail_internal['kk_tanggal_jam'] ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo">
                                    ...
                                    <textarea class="form-control" id="form-tw_tidak_q1" name="dt[tw_tidak_q1]"><?= $kecelakaan_detail_internal['tw_tidak_q1'] ?> </textarea>
                                </div>
                                <div class="form-group" id="ifNo1">
                                    <label for="form-tw_tidak_q2">Siapa yang seharusnya melakukan tugas/kegiatan tersebut ?</label>
                                    <textarea class="form-control" id="form-tw_tidak_q2" name="dt[tw_tidak_q2]"><?= $kecelakaan_detail_internal['tw_tidak_q2'] ?></textarea>
                                </div>
                                <div class="form-group" id="ifNo2">
                                    ...
                                    <textarea class="form-control" id="form-tw_tidak_q3" name="dt[tw_tidak_q3]"><?= $kecelakaan_detail_internal['tw_tidak_q3'] ?></textarea>
                                </div>
                                <!-- JAGA JARAK -->
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifYes3">
                                    ...
                                    <textarea class="form-control" id="form-sp_ya_1" name="dt[sp_ya_1]"><?= $kecelakaan_detail_internal['sp_ya_1'] ?></textarea>
                                </div>
                                <div class="form-group" id="ifNo3">
                                    <label for="form-sp_tidak_1">Dimana atasan penderita berada ?</label>
                                    <textarea class="form-control" id="form-sp_tidak_1" name="dt[sp_tidak_1]"><?= $kecelakaan_detail_internal['sp_tidak_1'] ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo4">
                                    ...
                                    <textarea class="form-control" id="form-sp_tidak_2" name="dt[sp_tidak_2]"><?= $kecelakaan_detail_internal['sp_tidak_2'] ?></textarea>
                                </div>
                                <!-- JAGA JARAK -->
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo5">
                                    ...
                                    <textarea class="form-control" id="form-pk_tidak_1" name="dt[pk_tidak_1]"><?= $kecelakaan_detail_internal['pk_tidak_1'] ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo6">
                                    ...
                                    <textarea class="form-control" id="form-pk_tidak_2" name="dt[pk_tidak_2]"><?= $kecelakaan_detail_internal['pk_tidak_2'] ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo7">
                                    ...
                                    <textarea class="form-control" id="form-pk_tidak_3" name="dt[pk_tidak_3]"><?= $kecelakaan_detail_internal['pk_tidak_3'] ?></textarea>
                                </div>
                                <!-- JAGA JARAK -->
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifYes8">
                                    ...
                                    <textarea class="form-control" id="form-papd_ya_1" name="dt[papd_ya_1]"><?= $kecelakaan_detail_internal['papd_ya_1'] ?></textarea>
                                </div>
                                <div class="form-group" id="ifNo8">
                                    <label for="form-papd_tidak_1">Mengapa alat pelindung diri tidak digunakan ?</label>
                                    <textarea class="form-control" id="form-papd_tidak_1" name="dt[papd_tidak_1]"><?= $kecelakaan_detail_internal['papd_tidak_1'] ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="form-papd_apd">Alat pelindung diri apa yang sesuai dengan pekerjaan tersebut ?</label>
                                    <textarea class="form-control" id="form-papd_apd" name="dt[papd_apd]"><?= $kecelakaan_detail_internal['papd_apd'] ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo9">
                                    ...
                                    <textarea class="form-control" id="form-papd_tidak_2" name="dt[papd_tidak_2]"><?= $kecelakaan_detail_internal['papd_tidak_2'] ?></textarea>
                                </div>
                                <!-- JAGA JARAK -->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="form-md_fungsi_alat" name="dt[md_fungsi_alat]"><?= $kecelakaan_detail_internal['md_fungsi_alat'] ?></textarea>
                                ...
                                <div class="form-group" id="ifNo10">
                                    ...
                                    <textarea class="form-control" id="form-md_ya_1" name="dt[md_ya_1]"><?= $kecelakaan_detail_internal['md_ya_1'] ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo12">
                                    ...
                                    <textarea class="form-control" id="form-md_tidak_4" name="dt[md_tidak_4]"><?= $kecelakaan_detail_internal['md_tidak_4'] ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo13">
                                    ...
                                    <textarea class="form-control" id="form-md_ya_5" name="dt[md_ya_5]"><?= $kecelakaan_detail_internal['md_ya_5'] ?></textarea>
                                </div>
                                <!-- JAGA JARAK -->
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifYes14">
                                    ...
                                    <textarea class="form-control" id="form-snp_ya_1" name="dt[snp_ya_1]"><?= $kecelakaan_detail_internal['snp_ya_1'] ?></textarea>
                                </div>
                                <div class="form-group" id="ifNo14">
                                    <label for="form-snp_tidak_1">Apakah prosedur/instruksi kerja perlu diperbaiki ? Jelaskan.</label>
                                    <textarea class="form-control" id="form-snp_tidak_1" name="dt[snp_tidak_1]"><?= $kecelakaan_detail_internal['snp_tidak_1'] ?></textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="form-snp_adakah_1" name="dt[snp_adakah_1]"><?= $kecelakaan_detail_internal['snp_adakah_1'] ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" id="ifNo15">
                                    ...
                                    <textarea class="form-control" id="form-snp_tidak_2" name="dt[snp_tidak_2]"><?= $kecelakaan_detail_internal['snp_tidak_2'] ?></textarea>
                                </div>
                                <!-- JAGA JARAK -->
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Ada fume" <?PHP print $adafume; ?>>
                                                <label for="Tidak">Ada fume</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Getaran" <?PHP print $getaran; ?>>
                                                <label for="Tidak">Getaran</label>
                                            </td>
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Ketinggian" <?PHP print $ketinggian; ?>>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="radio" name="keadaan[]" value="Kebisingan" <?PHP print $kebisingan; ?>>
                                                <label for="Tidak">Kebisingan</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Ada gas" <?PHP print $adagas; ?>>
                                                <label for="Tidak">Ada gas</label>
                                            </td>
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Di kedalaman" <?PHP print $dikedalaman; ?>>
                                                <label for="Tidak">Di kedalaman</label>
                                            </td>
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Panas sinar matahari" <?PHP print $panassinarmatahari; ?>>
                                                <label for="Tidak">Panas sinar matahari</label>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Lembab" <?PHP print $lembab; ?>>
                                                <label for="Tidak">Lembab</label>
                                            </td>
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Ada vapour" <?PHP print $adavapour; ?>>
                                                <label for="Tidak">Ada vapour</label>
                                            </td>
                                            <td>
                                                <input type="checkbox" name="keadaan[]" value="Ruang tertutup" <?PHP print $ruangtertutup; ?>>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="form-pttk_apkh_1" name="dt[pttk_apkh_1]"><?= $kecelakaan_detail_internal['pttk_apkh_1'] ?></textarea>
                                </div>
                                <div class="form-group">
