...
class Kecelakaan_detail_ekternal extends MY_Controller
{
	...
	{
		$kecelakaan_detail_ekternal = $this->mymodel->selectDataone('kecelakaan_detail_ekternal', array('id' => $id));
		$data['id'] = $kecelakaan_detail_ekternal['id'];
		$data['page_name'] = "kecelakaan_detail_ekternal";

		$this->load->view('master/kecelakaan_detail_ekternal/modal-tolak', $data);
	}
