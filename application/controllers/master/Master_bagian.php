...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	$this->form_validation->set_rules('dt[nama]', '<strong>Nama</strong>', 'required');
...

		{
			...
			$data['master_bagian'] = $this->mymodel->selectDataone('master_bagian',array('id'=>$id));$data['file'] = $this->mymodel->selectDataone('file',array('table_id'=>$id,'table'=>'master_bagian'));$data['page_name'] = "master_bagian";
...

		{
				...
				$id = $this->input->post('id', TRUE);$file = $this->mymodel->selectDataone('file',array('table_id'=>$id,'table'=>'master_bagian'));
